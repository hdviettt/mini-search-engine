...
function SerpSidePanel({ engine, onSwitchToSearch }: { engine: SearchEngineState; onSwitchToSearch: () => void }) {
  ...
  return (
    <div className="bg-[var(--bg-card)] overflow-hidden h-full">
    ...
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      {hasResults && (
        <div className="lg:flex overflow-hidden">
          ...
          {/* SERP — mobile: full or hidden; desktop: full or 35% side panel */}
          <div className={`transition-all duration-500 ease-in-out overflow-hidden ${
            view === "search"
              ? "flex-1"
            ...
            {view === "search" ? (
              /* Full SERP */
              <div className="max-w-3xl mx-auto px-3 sm:px-4 pt-3 sm:pt-4 pb-12 sm:pb-16">
                    ...
                    return (
                      <div key={i} className="group" style={{ animation: `fade-in 0.3s ease-out ${i * 0.05}s both` }}>
                        ...
                        <a href={r.url} target="_blank" rel="noopener noreferrer" className="block">
                          <h3 className="text-[16px] sm:text-[18px] text-[var(--accent)] group-hover:underline leading-snug mb-1">{r.title}</h3>
                        </a>
