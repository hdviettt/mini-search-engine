...
export const initialNodes: Node[] = [
  ...
  // ============================================================
  {
    id: "label_build",
    type: "label",
    position: { x: 10, y: BY1 - 25 },
    data: { label: "BUILD (offline)" },
  },

  {
    ...
    data: {
      label: "Crawler",
      icon: "crawler",
      description: "Fetches pages via BFS",
      stats: [],
      status: "ready",
      color: "emerald",
    },
  ...
  },
  {
    ...
    data: {
      label: "Indexer",
      icon: "indexer",
      description: "Builds inverted index",
      stats: [],
      status: "ready",
      color: "blue",
    },
  },
  {
    ...
    data: {
      label: "PageRank",
      icon: "pagerank",
      description: "Link-based authority score",
      stats: [],
      status: "ready",
      color: "indigo",
    },
  },
  {
    ...
    data: {
      label: "Chunker",
      icon: "chunker",
      description: "~300 tokens @ sentence boundaries",
      stats: [],
      status: "ready",
      color: "violet",
    },
  },
  {
    ...
    data: {
      label: "Embedder",
      icon: "embedder",
      description: "512-dim vectors (Voyage)",
      stats: [],
      status: "ready",
      color: "purple",
    },
  ...
  },
  {
    ...
    data: {
      label: "PR Scores",
      icon: "scores",
      description: "Authority per page",
      stats: [],
      color: "indigo",
      active: false,
    },
  ...
  // ============================================================
  {
    id: "label_query",
    type: "label",
    position: { x: QS, y: QY1 - 25 },
    data: { label: "QUERY (per search)" },
  },

  {
    ...
    data: {
      label: "Search Query",
      icon: "query",
      description: "User enters a query",
      color: "amber",
      phase: "tokenizing",
      timeMs: null,
      summary: null,
...

  {
    ...
    type: "label",
    position: { x: QS, y: QY2 - 25 },
    data: { label: "> SEARCH PATH" },
  },
  {
    id: "label_ai_path",
    type: "label",
    position: { x: QA, y: QY2 - 25 },
    data: { label: "> AI OVERVIEW PATH" },
  },
...
export const initialEdges: Edge[] = [
  // === BUILD EDGES ===
  {
    ...
    target: "pages_db",
    type: "animated",
    data: { animated: false, pathType: "build", color: "var(--color-build)" },
    style: { strokeDasharray: "4,4", stroke: "var(--edge-color)" },
  },
  {
    id: "b-pages-indexer",
    source: "pages_db",
  ...
  // === SEARCH PATH ===
  {
    ...
    target: "tokenize",
    type: "animated",
    data: { animated: false, pathType: "search", color: "var(--color-search)" },
    style: { stroke: "var(--edge-query)" },
  },
  {
    id: "q-token-lookup",
    source: "tokenize",
  ...
  // === AI OVERVIEW PATH ===
  {
    ...
    target: "fanout",
    type: "animated",
    data: { animated: false, pathType: "ai", color: "var(--color-ai)" },
    style: { stroke: "var(--edge-query)" },
  },
  {
    id: "q-input-embed",
